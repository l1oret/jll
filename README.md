...
4. [El del nullish coalescing operator o operador de fusión nula](https://joseluislloret.es/nullish-coalescing-operator-operador-fusion-nula).
5. [El del optional chaining operator o operador de encadenamiento opcional](https://joseluislloret.es/optional-chaining-operator-operador-ecandenamiento-opcional).
6. [El de las pure functions o funciones puras](https://joseluislloret.es/pure-functions-funciones-puras)
